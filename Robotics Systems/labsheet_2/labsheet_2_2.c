...
void moving_forwards()
{
    wb_motor_set_velocity(left_motor, F_speed);
    wb_motor_set_velocity(right_motor, F_speed);
}
...
void rotate_right()
{
wb_motor_set_velocity(left_motor, R_speed);
wb_motor_set_velocity(right_motor, -R_speed);
}
